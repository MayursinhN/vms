...
<div class="header">
    <h1 class="page-header pull-left"> Referee Master </h1>
    <div class="add-button"><a href="<?php echo HTTP_SERVER; ?>managereference" class="btn-floating"><i
                    class="material-icons">add</i></a></div>
    <div class="clearfix"></div>
    <ol class="breadcrumb">
        <li><a href="<?php echo HTTP_SERVER; ?>">Home</a></li>
        <li class="active">Referee Master</li>
    </ol>
</div>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="inputer">
                                                            <div class="input-wrapper text-center"><a
                                                                        href="<?php echo HTTP_SERVER; ?>references/<?php echo $reference[$i]['ref_id']; ?>"
