...
<div class="header">
    <h1 class="page-header"> Manage Marital Status </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo HTTP_SERVER; ?>">Home</a></li>
        <li><a href="<?php echo HTTP_SERVER; ?>maritalstatus">List of Marital Status</a></li>
        <li class="active">Marital Status</li>
    </ol>
</div>
<div id="page-inner">
    <div class="card">
                ...
                <div class="col-lg-9">
                    <div class="padding20">
                        <form name="frm_marital_status" method="post" id="frm_marital_status"
                            ...
                            <div class="col-lg-9">
                                <div class="form-group">
                                    <textarea name="other" class="materialize-textarea"
                                ...
                                <div class="form-group">
                                    ...
                                    <?php } else { ?>
                                        <input type="submit" name="btn_add" class="waves-effect waves-light btn"
                                               value="SAVE">
                                    <?php } ?>
                                    <a href="<?php echo HTTP_SERVER; ?>maritalstatus"
    ...
    if (isset($_POST['btn_add'])) {
        ...
        $value = array($name, 'Marital Status', $other, $currentDate, 1);

        $staus_array = array_combine($field, $value);
        $obj->insert($staus_array, 'masters_list');
        $objsession->set('ads_message', 'Marital Status added successfully.');

        redirect(HTTP_SERVER . "maritalstatus");
    }
    ...
    if (isset($_POST['btn_update'])) {
        ...
        $value = array($name, $other, $currentDate);
        $staus_array = array_combine($field, $value);

        $obj->update($staus_array, 'masters_list', array('master_id' => $master_id));
        $objsession->set('ads_message', 'Marital Status updated successfully.');
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#frm_marital_status").validate({
                ...
                messages: {
                    name: "Please enter your marital status title",
                },
