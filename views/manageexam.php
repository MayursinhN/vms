...
<div class="header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo HTTP_SERVER; ?>exammaster">List of Exam</a></li>
...
<div id="page-inner">
    ...
    if (isset($_POST['btn_add'])) {
        ...
        $value = array($name, 'Exam', $other, $currentDate, 1);

        $staus_array = array_combine($field, $value);
        $obj->insert($staus_array, 'masters_list');
        $objsession->set('ads_message', 'Exam added successfully.');
    ...
    if (isset($_POST['btn_update'])) {
        ...
        $objsession->set('ads_message', 'Exam updated successfully.');
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#frm_marital_status").validate({
                ...
                messages: {
                    name: "Please enter your exam title",
                },
