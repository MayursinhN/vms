...
<div class="header">
    <h1 class="page-header pull-left"> Document Category Master </h1>
    <div class="add-button"><a href="<?php echo HTTP_SERVER; ?>managedoctypes" class="btn-floating"><i class="material-icons">add</i></a></div>
    <div class="clearfix"></div>
    <ol class="breadcrumb">
        <li><a href="<?php echo HTTP_SERVER; ?>">Home</a></li>
        <li class="active">Document Category Master</li>
    </ol>
</div>
        ...
        ?>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="inputer">
                                                            <div class="input-wrapper text-center"><a
                                                                        href="<?php echo HTTP_SERVER; ?>doctypes/<?php echo $marital[$i]['master_id']; ?>"
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo HTTP_SERVER; ?>managedoctypes/<?php echo $marital[$i]['master_id']; ?>"><i
...
if (isset($_GET['master_id'])) {
    ...
    if ($obj->update($data, 'masters_list', array('master_id' => $_GET['master_id'])) == true) {
        $objsession->set('ads_message', 'Doc type successfully deleted.');
