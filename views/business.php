...
$params = array(":active" => 1, ":category" => 'Business');
...
<div class="header">
    <h1 class="page-header pull-left"> Business Type Master </h1>
    <div class="add-button"><a href="<?php echo HTTP_SERVER; ?>managebusiness" class="btn-floating"><i
...
<div id="page-inner">
                                    ...
                                    for ($i = 0; $i < count($marital); $i++) {
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="inputer">
                                                            <div class="input-wrapper text-center"><a
                                                                        href="<?php echo HTTP_SERVER; ?>business/<?php echo $marital[$i]['master_id']; ?>"
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo HTTP_SERVER; ?>managebusiness/<?php echo $marital[$i]['master_id']; ?>"><i
    ...
    if (isset($_GET['master_id'])) {
        ...
        if ($obj->update($data, 'masters_list', array('master_id' => $_GET['master_id'])) == true) {
            $objsession->set('ads_message', 'Business type successfully deleted.');
            redirect(HTTP_SERVER . "business");
        }
    }
    ?>
