...
$params = array(":active" => 1, ":category" => 'medium');
...
<div class="header">
    <h1 class="page-header pull-left"> Medium of Instructions Master </h1>
    <div class="add-button"><a href="<?php echo HTTP_SERVER; ?>managemedium" class="btn-floating"><i class="material-icons">add</i></a></div>
    <div class="clearfix"></div>
    <ol class="breadcrumb">
        <li><a href="<?php echo HTTP_SERVER; ?>">Home</a></li>
        <li class="active">Medium of Instructions Master</li>
    </ol>
</div>
        ...
        ?>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="inputer">
                                                            <div class="input-wrapper text-center"><a
                                                                        href="<?php echo HTTP_SERVER; ?>medium/<?php echo $marital[$i]['master_id']; ?>"
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo HTTP_SERVER; ?>managemedium/<?php echo $marital[$i]['master_id']; ?>"><i
...
if (isset($_GET['master_id'])) {
    ...
    if ($obj->update($data, 'masters_list', array('master_id' => $_GET['master_id'])) == true) {
        $objsession->set('ads_message', 'Medium successfully deleted.');
        redirect(HTTP_SERVER . "medium");
    }
}
?>
