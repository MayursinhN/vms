...
<div class="header">
    <h1 class="page-header"> Doc Types </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo HTTP_SERVER; ?>">Home</a></li>
        <li><a href="<?php echo HTTP_SERVER; ?>doctypes">List of Doc Types</a></li>
        <li class="active">Doc Types</li>
    </ol>
</div>
<div id="page-inner">
    <div class="card">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php } else { ?>
                                        <input type="submit" name="btn_add" class="waves-effect waves-light btn"
                                               value="SAVE">
                                    <?php } ?>
                                    <a href="<?php echo HTTP_SERVER; ?>doctypes"
    ...
    if (isset($_POST['btn_add'])) {
        ...
        $value = array($name, 'Doctype', $other, $currentDate, 1);

        $staus_array = array_combine($field, $value);
        $obj->insert($staus_array, 'masters_list');
        $objsession->set('ads_message', 'Doc type added successfully.');

        redirect(HTTP_SERVER . "doctypes");
    }
    ...
    if (isset($_POST['btn_update'])) {
        ...
        $objsession->set('ads_message', 'Doc Type updated successfully.');
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#frm_marital_status").validate({
                ...
                messages: {
                    name: "Please enter your doc title",
                },
