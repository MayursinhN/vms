...
<div class="header">
    <h1 class="page-header"> Visa </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo HTTP_SERVER; ?>">Home</a></li>
        <li><a href="<?php echo HTTP_SERVER; ?>visamaster">List of Visa</a></li>
...
<div id="page-inner">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php } else { ?>
                                        <input type="submit" name="btn_add" class="waves-effect waves-light btn"
                                               value="SAVE">
                                    <?php } ?>
                                    <a href="<?php echo HTTP_SERVER; ?>visamaster"
    ...
    if (isset($_POST['btn_add'])) {
        ...
        $value = array($name, 'Visa Type', "", $currentDate, 1);

        $staus_array = array_combine($field, $value);
        $obj->insert($staus_array, 'masters_list');
        $objsession->set('ads_message', 'Visa type added successfully.');

        redirect(HTTP_SERVER . "visamaster");
    }
    ...
    if (isset($_POST['btn_update'])) {
        ...
        $objsession->set('ads_message', 'Visa type updated successfully.');
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#frm_marital_status").validate({
                ...
                messages: {
                    name: "Please enter your visa title",
                },
