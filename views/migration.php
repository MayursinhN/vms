...
$params = array(":active" => 1, ":category" => 'migrate_name');
...
<div class="header">
    <h1 class="page-header pull-left"> Reason for Name Change Master </h1>
    <div class="add-button"><a href="<?php echo HTTP_SERVER; ?>managemigration" class="btn-floating"><i class="material-icons">add</i></a></div>
    <div class="clearfix"></div>
    <ol class="breadcrumb">
        <li><a href="<?php echo HTTP_SERVER; ?>">Home</a></li>
        <li class="active">Reason for Name Change Master</li>
    </ol>
</div>
        ...
        ?>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="inputer">
                                                            <div class="input-wrapper text-center"><a
                                                                        href="<?php echo HTTP_SERVER; ?>migration/<?php echo $marital[$i]['master_id']; ?>"
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo HTTP_SERVER; ?>managemigration/<?php echo $marital[$i]['master_id']; ?>"><i
...
if (isset($_GET['master_id'])) {
    ...
    if ($obj->update($data, 'masters_list', array('master_id' => $_GET['master_id'])) == true) {
        $objsession->set('ads_message', 'Migration successfully deleted.');
        redirect(HTTP_SERVER . "migration");
    }
}
?>
