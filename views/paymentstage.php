...
$params = array(":active" => 1, ":category" => 'PaymentStage');
...
<div class="header">
    <h1 class="page-header pull-left"> Payment Stage For Migration </h1>
    <div class="add-button"><a href="<?php echo HTTP_SERVER; ?>managepaymentstage" class="btn-floating"><i
                    class="material-icons">add</i></a></div>
    <div class="clearfix"></div>
    <ol class="breadcrumb">
        <li><a href="<?php echo HTTP_SERVER; ?>">Home</a></li>
        <li class="active">Payment Stage For Migration</li>
    </ol>
</div>
...
<div id="page-inner">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php if (count($marital)) {
                                    ...
                                    for ($i = 0; $i < count($marital); $i++) {
                                        ...
                                        $v_types = $obj->fetchRowConcate('masters_list', 'name', $marital[$i]['other']);
                                        $v_name = array();
                                        if ($v_types['name'] != "") {
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="inputer">
                                                            <div class="input-wrapper text-center"><a
                                                                        href="<?php echo HTTP_SERVER; ?>paymentstage/<?php echo $marital[$i]['master_id']; ?>"
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo HTTP_SERVER; ?>managepaymentstage/<?php echo $marital[$i]['master_id']; ?>"><i
    ...
    if (isset($_GET['master_id'])) {
        ...
        if ($obj->update($data, 'masters_list', array('master_id' => $_GET['master_id'])) == true) {
            $objsession->set('ads_message', 'Payment stage successfully deleted.');
