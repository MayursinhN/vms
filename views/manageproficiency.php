...
<div class="header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo HTTP_SERVER; ?>proficiency">List of Proficiency</a></li>
...
<div id="page-inner">
    ...
    if (isset($_POST['btn_add'])) {
        ...
        $value = array($name, 'Proficiency', $other, $currentDate, 1);

        $staus_array = array_combine($field, $value);
        $obj->insert($staus_array, 'masters_list');
        $objsession->set('ads_message', 'Proficiency added successfully.');
    ...
    if (isset($_POST['btn_update'])) {
        ...
        $objsession->set('ads_message', 'Proficiency updated successfully.');
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#frm_marital_status").validate({
                ...
                messages: {
                    name: "Please enter your proficiency title",
                },
