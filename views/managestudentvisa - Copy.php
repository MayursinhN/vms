                                    ...
                                    <form id="frmCourse"
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                ...
                                                <input id="name_of_intitute" name="name_of_intitute"
                                                       type="text"
                                                       class="validate"
                                                       value="">
                                                <label for="name_of_intitute">Name of Institute</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <div class="input-field col s2">
                                                    <label for="country_id">Country</label>
                                                ...
                                                <div class="input-field col s10">
                                                    <input type="hidden" id="expr_country_hidden" value="0">
                                                    <select name="country_id" class="form-control validate"
                                                            id="course_country_id">
                                                        <option value="">---Select---</option>
                                                        <?php if (!empty($country)) {
                                                            $selected = "";
                                                            for ($c = 0; $c < count($country); $c++) {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s6">
                                                <input id="course_add" name="address" type="text"
                                                       class="validate"
                                                       value="">
                                                <label for="since">Address</label>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <div class="input-field col s10">
                                                    <input id="course_phone_number" name="phone_number"
                                                           type="text"
                                                           class="validate"
                                                           value="">
                                                    <label for="since">Phone Number</label>
                                                </div>
                                            </div>
                                            <div class="input-field col s6">
                                                <div class="input-field col s10">
                                                    <input id="fax_number" name="fax_number"
                                                           type="text"
                                                           class="validate"
                                                           value="">
                                                    <label for="since">Fax Number</label>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <div class="input-field col s10">
                                                    <input id="course_email_address" name="email_address"
                                                           type="text"
                                                           class="validate"
                                                           value="">
                                                    <label for="email_address">Email Address</label>
                                    ...
                                    <div id="commission" class="col s12">
                                        <form id="frmCommission"
                                                ...
                                                <table class="table table-striped table-bordered table-hover"
                                                    ...
                                                    <?php if (count($student_course)) {
                                                        ...
                                                        for ($i = 0; $i < count($student_course); $i++) {
                                                            ...
                                                            ?>
                                                            <tr class="odd gradeX">
                                                                <td width="200"><?php echo ucfirst($student_course[$i]['name_of_intitute']); ?></td>
                                                                <td width="250"><?php echo $countries['name']; ?></td>
                                                                <td width="250"><?php echo $student_course[$i]['address']; ?></td>
                                                                <td width="250"><?php echo $student_course[$i]['campus']; ?></td>
                                                                <td width="250"><?php echo $student_course[$i]['course_name']; ?></td>
                                                                <td width="250"><?php echo $student_course[$i]['course_code']; ?></td>
                                                                <td width="180">
                                            ...
                                            <div class="allSemester" style="display: none;">
                                                <input type="hidden" id="commition_id" name="commition_id" value="0">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#frmCourse").validate({
            ...
            messages: {
                "name_of_intitute": "Please enter institute name",
                no_of_semester: {
                        ...
                        if (response.status == true) {
                            ...
                            if (course_id != "" && course_id > 0) {
                                ...
                                for (var i = 0; i < response.data.length; i++) {
                                    ...
                                    t.row.add([
                                        response.data[i].name_of_intitute,
    ...
    function editCommition(id, semester) {
        ...
        if (semester > 0) {
            ...
            $.ajax({
                type: "POST",
                url: base_url + "get_committion_data?commition_id=" + id,
                dataType: "html",
                success: function (response) {
            ...
            for (var i = 0; i < semester; i++) {
                strDuration += '<div class="input-field col s4"><input id="designation' + i + '" name="designations[]" type="text" class="validate" value=""><label for="designation">Designation</label></div><div class="input-field col s4"><input id="duration_start_date' + i + '" name="duration_start_date[]" type="text" class="validate" value=""><label for="sd">Start Date</label></div><div class="input-field col s4"><input id="duration_end_date' + i + '" name="duration_end_date[]" type="text" class="validate" value=""><label for="ed">End Date</label></div>';

                $('#duration_start_date' + i).datetimepicker({
                    autoclose: true,
                    format: "dd/mm/yyyy",
                    minView: 2
                });
            ...
            $('.noOfSemester').append(strDuration);
