...
<div class="header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo HTTP_SERVER; ?>relationship">List of Relationship</a></li>
...
<div id="page-inner">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php } else { ?>
                                        <input type="submit" name="btn_add" class="waves-effect waves-light btn"
                                               value="SAVE">
                                    <?php } ?>
                                    <a href="<?php echo HTTP_SERVER; ?>relationship"
    ...
    if (isset($_POST['btn_add'])) {
        ...
        $value = array($name, 'Relationship', $other, $currentDate, 1);

        $staus_array = array_combine($field, $value);
        $obj->insert($staus_array, 'masters_list');
        $objsession->set('ads_message', 'Relationship added successfully.');
    ...
    if (isset($_POST['btn_update'])) {
        ...
        $objsession->set('ads_message', 'Relationship updated successfully.');
