...
$params = array(":active" => 1, ":category" => 'Proficiency');
...
<div class="header">
    <h1 class="page-header pull-left"> English Proficiency Level Master </h1>
    <div class="add-button"><a href="<?php echo HTTP_SERVER; ?>manageproficiency" class="btn-floating"><i class="material-icons">add</i></a></div>
    <div class="clearfix"></div>
    <ol class="breadcrumb">
        <li><a href="<?php echo HTTP_SERVER; ?>">Home</a></li>
        <li class="active">English Proficiency Level Master</li>
    </ol>
</div>
        ...
        ?>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="inputer">
                                                            <div class="input-wrapper text-center"><a
                                                                        href="<?php echo HTTP_SERVER; ?>proficiency/<?php echo $marital[$i]['master_id']; ?>"
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo HTTP_SERVER; ?>manageproficiency/<?php echo $marital[$i]['master_id']; ?>"><i
...
if (isset($_GET['master_id'])) {
    ...
    if ($obj->update($data, 'masters_list', array('master_id' => $_GET['master_id'])) == true) {
        $objsession->set('ads_message', 'Proficiency successfully deleted.');
        redirect(HTTP_SERVER . "proficiency");
    }
}
?>
