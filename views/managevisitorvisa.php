...
if (isset($_GET['client_id'])) {
    ...
    $visitor_realtive = $obj->fetchRowAll('visitor_realtive', $cond, $params);
                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <ul class="tabs">
                                    ...
                                    <li class="tab col s3"><a
                                                class="<?php if ($types == "family") { ?> active <?php } ?>"
                                                id="tab_family"
                                                href="#family">Family Details</a>
                                    </li>
                                    <li class="tab col s3"><a
                                                class="<?php if ($types == "visit") { ?> active <?php } ?>"
                                                id="tab_visit" href="#visit">Reason For Visit</a></li>
                                    <li class="tab col s3"><a
                                                class="<?php if ($types == "medical") { ?> active <?php } ?>"
                                                id="tab_medical" href="#medical">Medical Condition & Treatment</a>
                                    </li>
                                    <li class="tab col s3"><a
                                                class="<?php if ($types == "overseas") { ?> active <?php } ?>"
                                                id="tab_overseas" href="#overseas">Overseas Relative</a>
                                    </li>
                                </ul>
                                ...
                                <div id="visit" class="col s12">
                                    <form id="frmVisit" class="wizard clearfix fv-form fv-form-bootstrap"
                                          method="post">
                                        <div class="row tech-var-div">

                                            <div class="input-field col s2">
                                                <label for="technical_skill">Reason For Visit</label>
                                            </div>
                                            <div class="input-field col s10 reason-v-div">
                                                <?php
                                                if ($visitor['reason_for_visit'] != "") {
                                                    $visitorData = explode(",", $visitor['reason_for_visit']);
                                                    foreach ($visitorData as $val) {
                                                        if ($val != "") {
                                                            ?>
                                                            <input id="reason_for_visit" name="reason_for_visit[]"
                                                                   type="text"
                                                                   class=""
                                                                   value="<?php echo $val; ?>"
                                                    ...
                                                    ?>
                                                    <input id="reason_for_visit" name="reason_for_visit[]" type="text"
                                                           class=""
                                                           value="" placeholder="Reason For Visit">
                                                    <?php
                                            ...
                                            <span id="reason_for_msg"></span>
                                            <div class="addButton">
                                                <a href="javascript:void(0);"
                                                   class="m-t-20 btn btn-primary reason-add"
                                                   style="margin-top:  8px;float: right;">More</a>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 text-right">
                                                <div class="form-group">
                                                    <a class="waves-effect waves-light btn" id="btn_reason_pre">
                                                        Previous
                                                    </a>
                                                    <input type="submit" class="waves-effect waves-light btn"
                                ...
                                <div id="medical" class="col s12">
                                    <form id="frmMedical" class="wizard clearfix fv-form fv-form-bootstrap"
                                          method="post">
                                        <div class="row tech-var-div">

                                            <div class="input-field col s2">
                                                <label for="technical_skill">Medical COndition & Treatment</label>
                                            </div>
                                            <div class="input-field col s10 medical-v-div">
                                                <?php
                                                if ($visitor['treatments'] != "") {
                                                    $visitorData = explode(",", $visitor['treatments']);
                                                    foreach ($visitorData as $val) {
                                                        if ($val != "") {
                                                            ?>
                                                            <input id="visitor_visa_details" name="visitor_visa_details[]"
                                                                   type="text"
                                                                   class=""
                                                                   value="<?php echo $val; ?>"
                                                                   placeholder="Medical Condition & Treatment">
                                                            <?php
                                                        }
                                                    }
                                                    ...
                                                    ?>
                                                    <input id="visitor_visa_details" name="visitor_visa_details[]" type="text"
                                                           class=""
                                                           value="" placeholder="Medical Condition & Treatment">
                                                    <?php
                                            ...
                                            <span id="medical_for_msg"></span>
                                            <div class="addButton">
                                                <a href="javascript:void(0);"
                                                   class="m-t-20 btn btn-primary medical-add"
                                                   style="margin-top:  8px;float: right;">More</a>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 text-right">
                                                <div class="form-group">
                                                    <a class="waves-effect waves-light btn" id="btn_medical_pre">
                                                        Previous
                                                    </a>
                                                    <input type="submit" class="waves-effect waves-light btn"
                                                           name="btn_tech_next" value="Next">
                                    ...
                                    <form id="frmOverseas"
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover"
                                                ...
                                                <tbody>
                                                <?php if (count($visitor_realtive)) {

                                                    for ($i = 0; $i < count($visitor_realtive); $i++) {

                                                        ?>
                                                        <tr class="odd gradeX">
                                                            <td width="200"><?php echo ucfirst($visitor_realtive[$i]['family_name']); ?></td>
                                                            <td width="250"><?php echo $visitor_realtive[$i]['given_name']; ?></td>
                                                            <td width="250"><?php echo $visitor_realtive[$i]['address']; ?></td>
                                                            <td width="250"><?php echo $visitor_realtive[$i]['phone_number']; ?></td>
                                                            <td width="250"><?php echo $visitor_realtive[$i]['email_address']; ?></td>
                                                            <td width="180">

                                                                <a href="javascript:void(0);"
                                                                   data-id="<?php echo $visitor_realtive[$i]['id']; ?>"
                                                                   class="update"
                                                                   onclick="editOverseas('<?php echo $visitor_realtive[$i]['id']; ?>');"><i
                                                                            style="padding: 0px;font-size: 20px;"
                                                                            class="fa fa-pencil-square-o"
                                                                            aria-hidden="true"></i></a>
                                                                <a href="javascript:void(0);"
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                ...
                                                <input id="overseas_id" name="overseas_id" type="hidden" value="0">

                                                <input id="overseas_family_name" name="family_name"
                                                       type="text"
                                                       class="validate"
                                                       value="">
                                                <label for="family_name">Family Name</label>
                                            ...
                                            <div class="input-field col s6">
                                                ...
                                                <input id="overseas_given_name" name="given_name"
                                                       type="text"
                                                       class="validate"
                                                       value="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s6">
                                                <div class="input-field col s10">
                                                    <input id="overseas_add" name="address"
                                                           type="text"
                                                           class="validate"
                                                           value="">
                                                    <label for="overseas_add">Address</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <div class="input-field col s10">
                                                    <input id="overseas_phone_number" name="phone_number"
                                                           type="text"
                                                           class="validate"
                                                           value="">
                                            ...
                                            <div class="input-field col s6">
                                                <div class="input-field col s10">
                                                    <input id="overseas_email_address" name="email_address"
                                                           type="text"
                                                           class="validate"
                                                           value="">
                                                    <label for="email_address">Email Address</label>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var strReason = '<div class="reason-for"><input id="reason_for_visit" name="reason_for_visit[]" type="text" class="" value="" placeholder="Reason For Visit"><i class=\"fa fa-trash-o remove-reason-div\"></i></div>';
        $(document).on('click', '.reason-add', function () {
            $('.remove-reason-div').removeClass('hidden');
            $('.reason-v-div').append(strReason);
        });

        $(document).on('click', '.remove-reason-div', function () {
            $(this).parent('.reason-for').remove();
        });

        var strPersonal = '<div class="medical-treatment"><input id="visitor_visa_details" name="visitor_visa_details[]" type="text" value="" placeholder="Medical Condition & Treatment" ><i class=\"fa fa-trash-o remove-medical-div\"></i></div>';
        $(document).on('click', '.medical-add', function () {
            $('.medical-v-div').append(strPersonal);
        });

        $(document).on('click', '.remove-medical-div', function () {
            $(this).parent('.medical-treatment').remove();
        });
        ...
        /*Oversease detail added in database using ajax call*/
        $("#frmOverseas").validate({
            debug: false,
            errorClass: "error",
            errorElement: "span",
            rules: {
            ...
            messages: {
                "family_name": "Please enter institute name",
            },
            highlight: function (element, errorClass) {
                $('input').removeClass('error');
            },
            submitHandler: function (form) {
                ...
                var inquiry_id = $("#login_id").val();
                var overseas_id = $("#overseas_id").val();

                $.ajax({
                    type: "POST",
                    url: base_url + "submit_overseas_data?inquiry_id=" + inquiry_id,
                    data: $("#frmOverseas").serialize(),
                    dataType: "json",
                    success: function (response) {
                        console.log(response);
                        if (response.status == true) {

                            $('#frmOverseas .validate').val('');

                            var t = $('#overseasTable').DataTable();

                            if (overseas_id != "" && overseas_id > 0) {

                                $('#overseasTable').dataTable().fnClearTable();

                                var clk = "return confirm('Are you sure want to delete?')";

                                for (var i = 0; i < response.data.length; i++) {

                                    var link = '<a href="javascript:void(0);" data-id="' + response.data[i].overseas_id + '" class="update" onclick="editOverseas(' + response.data[i].overseas_id + ');" ><i\n style="padding: 0px;font-size: 20px;"\n class="fa fa-pencil-square-o"\n aria-hidden="true"></i></a><a href="javascript:void(0);" data-id="' + response.data[i].overseas_id + '" class="remove"><i style="padding: 5px !important;font-size: 20px;" class="fa fa-times" aria-hidden="true"></i></a>';

                                    t.row.add([
                                        response.data[i].family_name,
                                        response.data[i].given_name,
                                        response.data[i].address,
        ...
        $("#frmRelaive").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "POST",
                    url: base_url + "submit_visitor_family_data?inquiry_id=" + inquiry_id,
        ...
        /*Reason for visit added in database using ajax call*/
        $("#frmVisit").validate({
            debug: false,
            errorClass: "error",
            errorElement: "span",
            ...
            errorPlacement: function (error, element) {
                if (element.attr("name") == "reason_for_visit[]") {
                    error.insertAfter("#reason_for_msg");
                } else {
                    error.insertAfter(element);
                }
            },
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "POST",
                    url: base_url + "submit_visit_data?inquiry_id=" + inquiry_id,
                    data: $("#frmVisit").serialize(),
                    dataType: "json",
                    success: function (response) {
                        console.log(response);
                        if (response.status == true) {

                            $('#frmVisit .validate').val('');
                            $("#tab_medical").click();
        ...
        /*Medical detail added in database using ajax call*/
        $("#frmMedical").validate({
            debug: false,
            errorClass: "error",
            errorElement: "span",
            rules: {
                "visitor_visa_details[]": "required",
            },
            messages: {
                "visitor_visa_details[]": "Please enter medical condition & treatment"
            },
            highlight: function (element, errorClass) {
                $('input').removeClass('error');
            },
            errorPlacement: function (error, element) {
                if (element.attr("name") == "visitor_visa_details[]") {
                    error.insertAfter("#medical_for_msg");
                } else {
                    error.insertAfter(element);
                }
            },
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "POST",
                    url: base_url + "submit_medical_data?inquiry_id=" + inquiry_id,
                    data: $("#frmMedical").serialize(),
                    dataType: "json",
                    success: function (response) {
                        console.log(response);
                        if (response.status == true) {

                            $('#frmMedical .validate').val('');
                            $("#tab_overseas").click();
        ...
        $('#frmOverseas').on('click', 'a.remove', function (e) {

            if (confirm('Are you sure want to delete?') == false) {
                return false;
            }

            var table = $('#overseasTable').DataTable();
            table.row($(this).closest('tr')).remove().draw(false);
            ...
            $.ajax({
                type: "POST",
                url: base_url + "delete_overseas_data?overseas_id=" + id,
                dataType: "json",
                success: function (response) {
        ...
        $('#frmVisit').on('click', '#btn_reason_pre', function (e) {
            $("#tab_family").click();
            $('html, body').animate({scrollTop: 0}, 1000);
        });

        $('#frmMedical').on('click', '#btn_medical_pre', function (e) {
            $("#tab_visit").click();
            $('html, body').animate({scrollTop: 0}, 1000);
        });
    ...
    function editOverseas(id) {

        $("#overseas_id").val(id);

        $.ajax({
            type: "POST",
            url: base_url + "get_overseas_data?overseas_id=" + id,
            dataType: "json",
            success: function (response) {

                if (response.status == true) {

                    $("#overseas_family_name").val(response.family_name);
                    $("#overseas_given_name").val(response.given_name);
                    $("#overseas_relation_id").val(response.relation_id);
                    $("#overseas_add").val(response.address);
                    $("#overseas_phone_number").val(response.phone_number);
                    $("#overseas_email_address").val(response.email_address);
