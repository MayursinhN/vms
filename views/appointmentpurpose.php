...
<div class="header">
    <h1 class="page-header pull-left"> Specific Purpose of Meeting </h1>
    <div class="add-button"><a href="<?php echo HTTP_SERVER; ?>managepurpose" class="btn-floating"><i
                    class="material-icons">add</i></a></div>
    <div class="clearfix"></div>
    <ol class="breadcrumb">
        <li><a href="<?php echo HTTP_SERVER; ?>">Home</a></li>
        <li class="active">Specific Purpose of Meeting</li>
    </ol>
</div>
...
<div id="page-inner">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php if (count($visadocument)) {
                                    ...
                                    for ($i = 0; $i < count($visadocument); $i++) {
                                        ...
                                        $userTypes = $obj->fetchRowConcate('masters_list', 'name', $visadocument[$i]['other']);
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="inputer">
                                                            <div class="input-wrapper text-center"><a
                                                                        href="<?php echo HTTP_SERVER; ?>appointmentpurpose/<?php echo $visadocument[$i]['master_id']; ?>"
                                        ...
                                        <tr class="odd gradeX">
                                            <td width="150"><?php echo $visadocument[$i]['name']; ?></td>
                                            <td width="150"><?php echo $userTypes['name']; ?></td>
                                            <td width="75" class="text-center">
                                                <a href="<?php echo HTTP_SERVER; ?>managepurpose/<?php echo $visadocument[$i]['master_id']; ?>"><i
    ...
    if (isset($_GET['master_id'])) {
        ...
        if ($obj->update($data, 'masters_list', array('master_id' => $_GET['master_id'])) == true) {
            $objsession->set('ads_message', 'Purpose successfully deleted.');
            redirect(HTTP_SERVER . "appointmentpurpose");
        }
    }
    ?>
