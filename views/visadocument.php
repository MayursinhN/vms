...
$params = array(":active" => 1, ":category" => 'visadocument');
...
<div class="header">
    <h1 class="page-header pull-left"> Visa Document Master </h1>
    <div class="add-button"><a href="<?php echo HTTP_SERVER; ?>managevisadoc" class="btn-floating"><i
                    class="material-icons">add</i></a></div>
    <div class="clearfix"></div>
    <ol class="breadcrumb">
        <li><a href="<?php echo HTTP_SERVER; ?>">Home</a></li>
        <li class="active">Visa Document List</li>
    </ol>
</div>
...
<div id="page-inner">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php if (count($visadocument)) {
                                    ...
                                    for ($i = 0; $i < count($visadocument); $i++) {
                                        ...
                                        $cond = "master_id =:doc_id";
                                        $params = array(":doc_id" => $visadocument[$i]['doc_id']);

                                        $doc_type = $obj->fetchRow('masters_list', $cond, $params);
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="inputer">
                                                            <div class="input-wrapper text-center"><a
                                                                        href="<?php echo HTTP_SERVER; ?>business/<?php echo $visadocument[$i]['master_id']; ?>"
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td width="75" class="text-center">
                                                <a href="<?php echo HTTP_SERVER; ?>managevisadoc/<?php echo $visadocument[$i]['master_id']; ?>"><i
    ...
    if (isset($_GET['master_id'])) {
        ...
        if ($obj->update($data, 'masters_list', array('master_id' => $_GET['master_id'])) == true) {
            $objsession->set('ads_message', 'Visa Document successfully deleted.');
